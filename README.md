...
## Technologies Utilized
 ...
 - A user can modify and delete only his/her own article. But all of the users can view all of the articles.
 ...
 - __Like__ feature is implemented with JQuery asynchronous request and the Comment button is implemented with using form submit.
